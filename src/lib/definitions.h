...
static const defs::PartitionID* begin(std::pair<defs::PartitionID*, defs::PartitionID*>& x) {
  return x.first;
}

static const defs::PartitionID* end(std::pair<defs::PartitionID*, defs::PartitionID*>& x) {
  return x.second;
}
}  // namespace std
