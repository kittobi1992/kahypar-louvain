...
#pragma GCC diagnostic pop
 ...
 public:
  ...
  void uncontract(const Memento& memento, GainChanges& changes,
    ...
    // TODO(schlag): ensure reset ouside!!!!
    // changes_u.resize(_k, 0);
    // changes_v.resize(_k, 0);
    // std::fill(changes_u.begin(), changes_u.end(),0);
    // std::fill(changes_v.begin(), changes_v.end(),0);
